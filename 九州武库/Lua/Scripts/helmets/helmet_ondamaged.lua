Hook.Add("character.applyDamage", "TSM_helmet_ondamaged", function(characterHealth, attackResult, hitLimb)
    ...
    if characterHealth.GetAffliction("tsm_armor_faceshield_100") or characterHealth.GetAffliction("tsm_armor_faceshield_80") or characterHealth.GetAffliction("tsm_armor_faceshield_60") or characterHealth.GetAffliction("tsm_armor_faceshield_40") or characterHealth.GetAffliction("tsm_armor_faceshield_20") or characterHealth.GetAffliction("tsm_armor_jaw") then
